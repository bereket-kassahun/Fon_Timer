...
import com.fontimer.besttimer.R
import com.fontimer.besttimer.data.preference.PreferenceManager
...
class PrivacyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        privacyLink.setOnClickListener{
            val url = "https://docs.google.com/document/d/1dV_MaTCvH2Pu-OVmAd-GA1HOVQGt6ceOFTVvzaqHJl0/edit?usp=sharing"
